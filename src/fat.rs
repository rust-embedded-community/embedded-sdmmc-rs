...
impl FatVolume {
    ...
    pub fn update_info_sector<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &mut self,
    ...
    /// Write a new entry in the FAT
    fn update_fat<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &mut self,
        controller: &mut Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
        cluster: Cluster,
        new_value: Cluster,
    ...
    pub(crate) fn next_cluster<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &self,
        controller: &Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
        cluster: Cluster,
    ...
    /// needed
    pub(crate) fn write_new_directory_entry<
        D,
        T,
    ...
    pub(crate) fn iterate_dir<D, T, F, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &self,
        controller: &Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
        dir: &Directory,
        mut func: F,
    ...
    fn find_entry_in_block<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &self,
        controller: &mut Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
        fat_type: FatType,
    ...
    pub(crate) fn delete_directory_entry<
        D,
        T,
        const MAX_OPEN_DIRS: usize,
        const MAX_OPEN_FILES: usize,
    ...
    fn delete_entry_in_block<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &self,
        controller: &mut Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
        match_name: &ShortFileName,
        block: BlockIdx,
    ...
    pub(crate) fn find_next_free_cluster<
        D,
        T,
        const MAX_OPEN_DIRS: usize,
        const MAX_OPEN_FILES: usize,
    ...
    pub(crate) fn alloc_cluster<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
        &mut self,
        controller: &mut Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
...
pub fn parse_volume<D, T, const MAX_OPEN_DIRS: usize, const MAX_OPEN_FILES: usize>(
    controller: &mut Controller<D, T, MAX_OPEN_DIRS, MAX_OPEN_FILES>,
    lba_start: BlockIdx,
